...
Sometimes the google place API will load venues that, for example, offer a bar and accommodation so that the icon is misleading. This will be resolved when I implement the planned feature of bespoke icons based upon user reviews and age, atmosphere or mood preference. 
